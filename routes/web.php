...
Route::get('/dostavka', [WebController::class, 'dostava'])->name('dostava');
Route::get('/partners', [WebController::class, 'partners'])->name('partners');
Route::get('/stats', [WebController::class, 'stats'])->name('stats');
...
Route::middleware('auth')->prefix('user')->group(function (){
    ...
    Route::post('/basket/{$product_id}/update', [BasketController::class, 'update'])->name('basket.update');
